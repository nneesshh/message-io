...
use crate::adapters::ws::error::{Error, ProtocolError, Result, UrlError};
use crate::adapters::ws::protocol::{Role, WebSocket, WebSocketConfig};

/// Client request type.
pub type Request = HttpRequest<()>;

/// Client response type.
pub type Response = HttpResponse<Option<NetPacketGuard>>;
...
impl<S: Read + Write> ClientHandshake<S> {
    ...
    pub fn start(
        ...
        let _ = crate::adapters::ws::client::uri_mode(request.uri())?;
...
mod tests {
    ...
    use crate::adapters::ws::client::IntoClientRequest;
