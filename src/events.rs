...
pub struct EventReceiver<E> {
    ...
    timer_receiver: channel::Receiver<(Instant, TimerCommand<E>)>,
    priority_receiver: channel::Receiver<E>,
...
pub struct EventSender<E> {
    ...
    timer_sender: channel::Sender<(Instant, TimerCommand<E>)>,
    priority_sender: channel::Sender<E>,
}
